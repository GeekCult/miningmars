...
const Trade = ({ item }: { item: any }): JSX.Element => {
  ...
  const closeOverScreen2 = function () {
    const element: any = document.getElementById("overScreen2");
    element.classList.remove("act");
  };
  ...
  return (
    <div className="Trade centerView">
      <div className="btn-close pointer" onClick={closeOverScreen2}>
        ...
        <div className="fr3">
          ...
          <div className="cflx">
            <div>
              ...
              <input
                type="number"
                className="form-control txt-plus mgR2 width-100"
                placeholder="Amount"
                value={amount}
                min="1"
                max={item.amount}
            ...
            <div>
              ...
              >
                <i className="fa fa-check"></i> Sell
              </button>
            </div>
          </div>
        </div>
