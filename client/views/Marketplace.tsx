...
const Marketplace = ({
        ...
        <div className="width350 center">
          ...
          <div className="center">
            ...
            <button
              ...
              onClick={() => runIt({ action: "Consume", props: props })}
            >
              Yes
            </button>
          </div>{" "}
  ...
  return (
    <div className="Marketplace centerView">
      <div className="btn-close pointer" onClick={closeOverScreen}>
      ...
      >
        <div className="cflx gap-10 mgB">
          <div className="fr4">
            <input
              type="text"
              placeholder="Search for a special item"
              className="form-control txt-plus mgR0"
              value=""
              onChange={(e) => alert("search")}
            />
          </div>
          <div className="fr4">
            <button
              className="btn btn-main btn-plus"
              onClick={() => {
                alert("Search");
              }}
            >
        ...
        <div className="row">
          {Object.keys(store.data.data).map((d) => {
            return (
              <div className="col-md-6" key={store.data.data[d].id}>
                <div className="pp_square_black ">
                  <div className="cflx gap-10">
                    <div className="fr2">
                      <img
                        src={"./imagens/" + store.data.data[d].image}
                        className="mgR2 picMarketPlace"
                      />
                    </div>
                    <div className="fr4">
                      <div className="cflxss">
                        <div className="fr1">
                          <h3 className="title mg0">
                            {store.data.data[d].title}
                          </h3>
                          <p
                            className="paragraph txt-white"
                            style={{ height: "50px" }}
                          >
                            {store.data.data[d].description}
                          </p>
                        </div>
                        <div className="fr1 cflx center-flex">
                          ...
                          <div className="cflx fr1 justify-right">
                            <img
                              ...
                              height="20"
                            />
                            <div className="mgL txt-white">
                              {store.data.data[d].value}
                            </div>
                          </div>
                        </div>
                      </div>
      ...
      >
        ...
        {Object.keys(items.data.data).map((d) => {
          return (
            <div
              className="cflx gap-10 pp_square_black center-flex"
              ...
              <div className="fr5">
                <div className="cflx center-flex">
                  <img
                    ...
                    className="mgR2"
                  />
                  <div className="badge2 mgR">
                    {items.data.data[d].amount} x
                  </div>
