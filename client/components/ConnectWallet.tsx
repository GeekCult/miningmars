...
const ConnectButton = ({
  ...
  return (
    <div className="buttons">
      ...
      <button className="button" onClick={connectTemple}>
        <span>
          <i className="fas fa-wallet"></i>&nbsp; Connect with Temple
        </span>
      </button>
      <button className="button hide" disabled={loadingNano} onClick={connectNano}>
        {loadingNano ? (
          <span>
